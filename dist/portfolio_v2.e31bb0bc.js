...
var navAbout = document.querySelector('.top-nav a[href="#section-1"]');
var navProjects = document.querySelector('.top-nav a[href="#section-2"]');
var navContacts = document.querySelector('.top-nav a[href="#section-3"]');
var about = document.querySelector('section[class="about"]');
var projects = document.querySelector('section[class="projects"]');
...
window.addEventListener('scroll', function () {
  ...
  topNav.style.transform = 'translateY(0)'; // Use ratio so it works the same for all viewport size

  var scrollRatio = window.scrollY / container.scrollHeight; // console.log(scrollRatio);

  if (scrollRatio >= 0.71) {
    navContacts.style.color = '#ff3f74';
    [navProjects, navAbout].forEach(function (item) {
    ...
    [navAbout, navContacts].forEach(function (item) {
      return item.style.color = 'white';
    });
...
},{}],"../../../../AppData/Roaming/nvm/v12.0.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../AppData/Roaming/nvm/v12.0.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/portfolio_v2.e31bb0bc.js.map